...
- โพสต์จากเพจ
- โพสต์ในกลุ่ม Public และ Private ที่บัญชีเข้าถึงได้ ทั้งกลุ่มแบบ ID และชื่อ เช่น `/groups/thaidev/`
- โพสต์ทั่วไปบน News Feed
- หน้าโพสต์เดี่ยว เช่น `/posts/`, `/permalink/`, `/permalink.php` และ `/story.php`
- โพสต์รูปภาพ วิดีโอ และ Facebook Reel ผ่าน `/reel/`, `/watch/`, `/video.php` หรือ `/share/`
...
- เปิดหรือซ่อนปุ่ม `📊 ดึงความเห็น` ได้จาก Side Panel และจำค่าอัตโนมัติ
...
| ตัวเลือก | รายละเอียด |
|---|---|
| Inline button | เปิดหรือซ่อนปุ่ม `📊 ดึงความเห็น` บนหน้า Facebook |
